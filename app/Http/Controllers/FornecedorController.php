...
class FornecedorController extends Controller
{
    ...
    public function adicionar(Request $request){
        ...
        if($request->input('_token') != '' && $request->input('id') == ''){
            ...
            $feedback = [
                'required' => 'O campo :attribute deve ser preenchido', //:attribute recupera o nome do campo do input
    ...
    public function excluir($id){
        $fornecedor = Fornecedor::find($id);
        $fornecedor->delete();
        //$fornecedor->forceDelete(); forceDelete apaga os registros apagados com softDelete
